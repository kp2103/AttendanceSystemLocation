...
const SignUp = props => {
  ...
  const changeUserFname = useCallback(
    value => {
      setFname(value);
    },
    [fname],
  );
  const changeUserLname = useCallback(
    value => {
      setLnamename(value);
    },
    [lname],
        ...
        <View style={style.mianContainer}>
          <View style={style.lottieView}>
            <LottieView
              ...
              loop
              autoPlay
              source={require('../LottieAnimations/welcome3.json')}></LottieView>
          </View>
          ...
          <View style={{flex: 1, marginBottom: 10}}>
            <ScrollView
              ...
              <TextInput
                ...
                style={style.textInput}
                onChangeText={value => {
                  changeUserLname(value);
                }}
                mode="outlined"
                label={'Last Name'}
                activeOutlineColor="dodgerblue"
                outlineStyle={{borderRadius: 10}}></TextInput>
              ...
              <Text
                ...
                style={{color: 'dodgerblue', fontSize: 20, marginBottom: 8}}>
                Go back to Signin
              </Text>
